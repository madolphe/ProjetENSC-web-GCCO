...
<head>
    ...
    <title>Structure des aéronefs</title>
</head>
    ...
    <div class='container'>
        ...
        <div class='col-md-10'>
            ...
            <h4><li>Composition générale d'un aéronef</li></h4>
                ...
                <p class='image'>
                <img src="../../images/image1.png" alt="Composition générale d'un aéronef" title="Composition générale d'un aéronef"/>
                </p>
                <p>
            ...
            <h4><li>Les différentes formules aérodynamiques</li></h4>
                ...
                <strong><li>Les ailes</li></strong>
                    ...
                    <u><li>Formes classiques d'ailes</li></u>
                        ...
                        <p class='image'>
                        <img src="../../images/image2.png" alt="Différents types d'ailes" title="Différents types d'ailes"/><br/>
                        </p>
                        <p>
                        ...
                        <p class='image'>
                        <img src="../../images/image5.png" alt="Ailes en position basse et haute" title="Ailes en position basse et haute"/>
                        <img src="../../images/image6.png" alt="Ailes en position médiane" title="Ailes en position médiane"/>
                        </p>
                    <u><li>Dièdre des ailes</li></u>
                        ...
                        <p class='image'>
                        <img src="../../images/image3.png" alt="Dièdres nul et négatif" title="Dièdres nul et négatif"/>
                        <img src="../../images/image4.png" alt="Dièdre positif" title="Dièdre positif"/>
                        </p>
                        <p>
                ...
                <strong><li>Le fuselage</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image7.png" alt="Fuselages cylindrique, en coque et carré" title="Fuselages cylindrique, en coque et carré"/>
                    </p>
                <strong><li>Les empennages</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image8.png" alt="Différents empennages" title="Différents empennages"/>
                    </p>
                </ol>
                <hr/>
            ...
            <h4><li>Les dispositifs hypersustentateurs</li></h4>
                ...
                <strong><li>Les volets de bord de fuite</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image9.png" alt="Différents types de volet de bord de fuite" title="Différents types de volet de bord de fuite"/>
                    </p>
                <strong><li>Les becs de bord d'attaque</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image10.png" alt="Différents types de volet de bord d'attaque" title="Différents types de volet de bord d'attaque"/><br/>
                    </p>
                    <p>Voici quelques exemples hypersustentateurs :</p>
                    <p class='image'>
                    <img src="../../images/image11.png" alt="Exemples de dispositifs hypersustentateurs" title="Exemples de dispositifs hypersustentateurs"/>
                    </p>
                </ol>
                <hr/>
            ...
            <h4><li>Le train d'atterrissage</li></h4>
                ...
                <strong><li>Les trains classiques</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image12.png" alt="Train d'atterrissage classique" title="Train d'atterrissage classique"/>
                    </p>
                    <p>
                ...
                <strong><li>Les trains tricycles</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image13.png" alt="Train d'atterrissage tricycle" title="Train d'atterrissage tricycle"/>
                    </p>
                    <p>
            ...
            <h4><li>Les commandes de vol</li></h4>
                ...
                <strong><li>Les axes de mouvement</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image14.png" alt="Les 3 axes de mouvement d'un avion" title="Les 3 axes de mouvement d'un avion"/>
                    </p>
                <strong><li>Le contrôle en tangage</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image15.png" alt="Contrôle en tangage" title="Contrôle en tangage"/>
                    </p>
                <strong><li>Le contrôle en roulis</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image16.png" alt="Contrôle en roulis" title="Contrôle en roulis"/>
                    </p>
                <strong><li>Le contrôle en lacet</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image17.png" alt="Contrôle en lacet" title="Contrôle en lacet"/>
                    </p>
                ...
                <strong><li>Le contrôle de la vitesse</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image18.png" alt="Freins aérodynamiques" title="Freins aérodynamiques"/>
                    </p>
                <strong><li>Les dispositifs de transmission</li></strong>
                    ...
                    <p class='image'>
                    <img src="../../images/image19.png" alt="" title=""/>
                    </p>
                    <p>
                    ...
                    <p class='image'>
                    <img src="../../images/image20.png" alt="" title=""/>
                    </p>
                    <p>
                    ...
                    <p class='image'>
                    <img src="../../images/image21.png" alt="" title=""/>
                    </p>
                </ol>
            </ol>
        </div>

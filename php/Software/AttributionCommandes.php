...
<main class="page landing-page">
    ...
    <section class="clean-block clean-hero" style="background-color:rgb(230, 225, 225);">
        <div class = "text">
        <h1>FSUIPC4</h1>
        <p>Ce logiciel disponible depuis Flight simulator vous permettra de modifier ou d'ajouter de nouvelles commandes.<br>
            Pour cela, suivez les différentes étapes ci-dessous ou bien visionnez la vidéo suivante. </p><br>
    ...
    <section class="clean-block clean-hero" style="background-color:white;">
        ...
        <div class ="col-md-4">
        <h1>Etape 1</h1>
        <p>Lancez FSX en cliquant sur l'icône <img src="../../images/Icone.png" alt="Card image"/> pour démarrer FSX située dans la barre de navigation en bas de l’écran. Vous arrivez sur la page d’accueil de FSX.
    ...
    <section class="clean-block clean-hero" style="background-color:rgb(230, 225, 225);">
        ...
        <div class ="col-md-4">
            <h1>Etape 2</h1>
            <p>Une fois le chargement effectué, cliquez sur “<strong>Compléments</strong>” puis sur <strong>FSUIPC</strong> dans la barre de navigation en haut de la page. Si cette barre n’est pas accessible, cliquez sur la touche “Alt” du clavier.</p>
        </div>
    </section>
    ...
    <section class="clean-block clean-hero" style="background-color:white;">
        ...
        <div class ="col-md-4">
            <h1>Etape 3</h1>
            <p>Si la commande correspond à un bouton de type On/Off, poussoir, switch cliquez sur l’onglet “Button +Switches”. Cliquez ici.</p>
            <a href="#1"><button class="btn btn-primary" type="button">Button +Switches</button></a>
            <br/><br/>
            <p>Si la commande correspond à un bouton de type Axe (manette des gaz, commandes de direction), cliquez sur l’onglet “Axis Assignment”. Cliquez ici.<p>
        ...
        <section id = "1" class="clean-block clean-hero" style="background-color:rgb(230, 225, 225);">
            ...
            <div class ="col-md-4">
                ...
                <li>Enclenchez, appuyez sur le bouton pour lequel vous souhaitez attribuer une fonctionnalité. Des valeurs vos alors apparaître dans l’encadré rouge qui correspondent à un bouton en particulier.</li><br/>
                ...
                <li>Sinon cliquez sur “OK” et vérifié que votre commande est fonctionnelle.</li>

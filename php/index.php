...
<div class="container arborescence text-center">
    ...
    <div class="row">
        <div class="col-4 text-center">	<a href="Aeronautique/Aeronautique.php"><button type="button" class="btn btn-outline-primary center-block">Aéronautique</button></a>
        </div>
        <div class="col-4 text-center">	<a href="Software/BonneSimulation.php"><button type="button" class="btn btn-outline-primary">Simulation</button></a>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-4 text-center">	<a href="Software/CréationScénario.php"><button type="button" class="btn btn-outline-primary">Création d'un scénario</button></a>
        </div>
        <div class="row text-center">
    ...
    <div class="row">
        ...
        <div class="col-4 text-center">	<a href="Software/CréationScénarioPanne.php"><button type="button" class="btn btn-outline-primary">Scénario avec panne</button></a>
        </div>
    </div>
</div>
